  ...
  const testimonials = [
    {
      ...
      content: 'Smart retail has transformed how we discover and order products. The recommendations are spot-on!',
      rating: 5,
      avatar: 'RK'
    },
    {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-20">
            ...
            <p className={`text-xl text-blue-100 max-w-3xl mx-auto leading-relaxed ${isVisible.stats ? 'animate-slide-up' : 'opacity-0'}`} style={{ animationDelay: '0.3s' }}>
              See how Smart Retail is transforming B2B commerce across industries with impressive results.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-20">
            ...
            <p className={`text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed ${isVisible.testimonials ? 'animate-slide-up' : 'opacity-0'}`} style={{ animationDelay: '0.3s' }}>
              Join thousands of satisfied businesses that have transformed their operations with Smart Retail.
            </p>
          </div>
          ...
          <div className="border-t border-gray-800 mt-12 pt-8">
            <div className="flex flex-col md:flex-row justify-between items-center">
              <p className="text-gray-400 mb-4 md:mb-0">
                &copy; 2024 Smart Retail. All rights reserved. Built for the Stackhack Hackathon Challenge.
              </p>
